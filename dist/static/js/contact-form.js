...
function buildSocialLink(href, iconPath, labelId, labelKey) {
...
function buildContactSocialLink() {
    ...
    wrapper.append(buildSocialLink("https://www.linkedin.com/in/eduytingco/", LINKEDIN_ICON_PATH, "contact-linkedin-label", "contact.linkedin"), buildSocialLink("https://github.com/eduytingco/portfolio-site", GITHUB_ICON_PATH, "contact-github-label", "contact.github"));
    return wrapper;
}
